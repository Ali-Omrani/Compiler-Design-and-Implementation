...
actor returns [boolean synActorExists, List<String> receiverSign = new ArrayList<>()]:
  ...
  ad = actorDef {beginScope();} (abs = actorBodyStatement{
    if($abs.isReceiver){
...
actorBodyStatement returns[boolean isReceiver, String receiverString]:
  {//print("actorBodyStatement");
  }
	(dataDef[true]{$isReceiver = false; $receiverString = "";}('\n')+ | r = receiver{$isReceiver = true; $receiverString = $r.receiverString;})
;
...
receiver returns [String receiverString]:
	{//print("receiver");
	}
...
receiverDef returns [List<Variable> receiverArgs, String receiverString]:
